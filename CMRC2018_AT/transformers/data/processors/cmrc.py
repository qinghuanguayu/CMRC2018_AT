...
class CmrcProcessor(DataProcessor):
  ...
  def read_cmrc_examples_train(self, input_data, set_type):
  ...
  def read_cmrc_examples_dev(self, input_data, set_type):
    """Read a SQuAD json file into a list of SquadExample."""
  ...
  def get_train_examples(self, data_dir, filename=None):
    ...
    return self.read_cmrc_examples_train(input_data, "train")
  ...
  def get_dev_examples(self, data_dir, filename=None):
    ...
    with open(
      ...
      input_data = json.load(reader)["data"]
    return self.read_cmrc_examples_dev(input_data, "dev")
